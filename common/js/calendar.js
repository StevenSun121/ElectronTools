...
const calendar = {
    ...
    festival: {
        ...
        '3-23': {title: '世界气象日'},
        '3-24': {title: '世界防治结核病日'},
        '3-1-0': {title: '中小学安全教育日'}, // 三月最后一个星期一
        '4-7': {title: '世界卫生日'},
        '4-22': {title: '世界地球日'},
        '4-23': {title: '世界读书日'},
        '5-8': {title: '世界红十字日'},
        '5-0-2': {title: '母亲节'}, // 五月第二个星期日
        '5-12': {title: '全国防灾减灾日'},
        '5-15': {title: '全国碘缺乏病日'},
        '5-17': {title: '世界电信日'},
        '5-18': {title: '国际博物馆日'},
        '5-0-3': {title: '全国助残日'}, // 第三个星期日
        '5-25': {title: '国际爱肤日'},
        '5-31': {title: '世界无烟日'},
        '6-5': {title: '世界环境日'},
        '6-6': {title: '全国爱眼日'},
        '6-9': {title: '世界认可日'},
        '6-0-3': {title: '父亲节'}, // 第三个星期日
        '6-23': {title: '国际奥林匹克日'},
        '6-25': {title: '全国土地日'},
        '6-26': {title: '国际反毒品日'},
        '7-1': {title: '香港回归日'},
        ...
        '10-4': {title: '世界动物日'},
        '10-7': {title: '国际住房日'},
        '10-4-2': {title: '世界视力日'}, // 每年10月的第二个星期四
        '10-9': {title: '世界邮政日'},
        '10-10': {title: '世界精神卫生日'},
        '10-13': {title: '世界保健日'},
        '10-15': {title: '国际盲人节'},
    ...
    toAstro: function (cMonth, cDay) {
        ...
        let index = cMonth * 2 - (cDay < arr[cMonth - 1] ? 2 : 0);
